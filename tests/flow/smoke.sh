...
run station.php "go=1&start=2026-08-12&end=2026-08-13&sort=lines"      "岗位-按票数"     || fails=$((fails+1))
run station.php "go=1&start=2026-08-12&end=2026-08-13&sort=tickets"    "岗位-按下单次数" || fails=$((fails+1))
